...
class TimeBasedRiskManager:
    ...
    def __init__(self, config_manager: ConfigManager, position_manager = None):
        ...
        self.reduce_after_minutes = self.position_config.time_based_management.get('reduce_after_minutes', 30)
        self.close_after_minutes = self.position_config.time_based_management.get('close_after_minutes', 60)
        self.reduce_ratio = self.position_config.time_based_management.get('reduce_ratio', 0.5)
